...
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-swap/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-swap/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-swap.svg)](https://github.com/buluma/ansible-role-swap/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-swap.svg)](https://github.com/buluma/ansible-role-swap/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-swap.svg)](https://github.com/buluma/ansible-role-swap/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/swap)](https://galaxy.ansible.com/ui/standalone/roles/buluma/swap/documentation)|
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-swap/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-swap
